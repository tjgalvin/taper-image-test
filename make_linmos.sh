...
echo "linmos.outname          = ${OUTPUT}/example_datacolumn_image" >> "${DATAPARSET}"
echo "linmos.outweight        = ${OUTPUT}/example_datacolumn_weight" >> "${DATAPARSET}"
...
echo "linmos.beams = ${beamorder}" >> "${DATAPARSET}"
echo "linmos.imagetype        = fits" >> "${DATAPARSET}"
echo "linmos.outname          = ${OUTPUT}/example_testcolumn_image" >> "${DATAPARSET}"
echo "linmos.outweight        = ${OUTPUT}/example_testcolumn_weight" >> "${DATAPARSET}"
echo "linmos.weighttype      = FromPrimaryBeamModel" >> ${DATAPARSET}
echo "linmos.primarybeam      = ASKAP_PB" >> "${DATAPARSET}"
echo "linmos.primarybeam.ASKAP_PB.image = ${HOLOFILE}" >>  "${DATAPARSET}"
